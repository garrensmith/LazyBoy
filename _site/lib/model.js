...
var Document = function () {
  ...
  this.save_attributes = function (cb) {
    ...
    Object.keys(self).forEach(function (key) {
      ...
      if (self.schema[key] && self.schema[key].type.hasone) {
        associations.push(self[key]);
      };
    });
   
    async.forEach(associations, function (item, done) {
       item.save(done);
    }, cb);
...
var ModelDocument = function (model_type, schema, views) {
  ...
  self.create_with_references = function (model_data) {
